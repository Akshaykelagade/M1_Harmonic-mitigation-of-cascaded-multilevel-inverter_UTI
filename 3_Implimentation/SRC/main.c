...
v13=(400/(13*3.142))*(1.07*cos(13*theeta1))+(1.00*cos(13*theeta2))+(0.97*cos(13*theeta3)
 ...
 sqval=((v5*v5)+(v7*v7)+(v11*v11)+(v13*v13)); 
thd=sqrt(sqval); 
...
initial=1.07*cos(theeta1)+1.00*cos(theeta2)+0.97*cos(theeta3)+0.90*cos(theeta4)+0.5*cos(th
eeta5)-(3.92*m); 
...
f11=(1.07*cos(11*theeta1))+(1.00*cos(11*theeta2))+(0.97*cos(11*theeta3))+(0.90*cos(11*th
eeta4))+(0.5*cos(11*theeta5)); 
f13=(1.07*cos(13*theeta1))+(1.00*cos(13*theeta2))+(0.97*cos(13*theeta3))+(0.90*cos(13*th
eeta4))+(0.5*cos(13*theeta5)); 
...
j4=(matrix[3][0]*(3.92*m))+(matrix[3][1]*0)+(matrix[3][2]*0)+(matrix[3][3]*0)+(matrix[3][4
]*0);
j5=(matrix[4][0]*(3.92*m))+(matrix[4][1]*0)+(matrix[4][2]*0)+(matrix[4][3]*0)+(matrix[4][4
]*0); 
